...
angular.module('onScreenKeyboard').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/templates/angular-on-screen-keyboard.html',
    "<div class=keyboard cellspacing=2><div class=keyboard-row ng-repeat=\"row in ctrl.langs[ctrl.currentLayout]\"><div ng-repeat=\"key in row track by $index\" class=keyboard-item ng-click=\"ctrl.printKeyStroke(key, $event)\" ng-class=\"{'button': !key.type || key.type !== 'margin',\n" +
    ...
    "                           'alt': key.type === 'alt',\n" +
    "                           'lang': key.type === 'lang',\n" +
    "                           'lang-{{ctrl.currentLayout}}': true}\" class={{key.type}} ng-bind-html=ctrl.getText(key)></div></div></div>"
  );
