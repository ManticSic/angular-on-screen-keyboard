           ...
           return {
               ...
               controller: function( $sce ) {
                   ...
                   ctrl.getText = function( key ) {
                       ...
                       // nbsp to avoid miss alignment of empty containers (crazy)
                       return val.trim() ? val : $sce.trustAsHtml( '&nbsp;' );
                   };
               },
               link: function( scope, element, attr ) {
                   ...
                   ctrl.printKeyStroke = function( key, event ) {
                       ...
                       var htmlKeyVal = angular.element( event.target || event.srcElement )
                                               .text();
                   ...
                   ctrl.setKeyboardLayout = function() {
                       if( !ctrl.lastInputCtrl ) {
                           ...
                           ctrl.isUpperCase = false;
                       } else if( angular.element( ctrl.lastInputCtrl )
                                         .val().length === 0 ) {
                           ctrl.isUpperCase = true;
                       }
                       else {
